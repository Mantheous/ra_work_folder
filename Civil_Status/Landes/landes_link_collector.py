# Scraper for "https://archives.landes.fr/faire-une-recherche/archives-numerisees/etat-civil?arko_default_62a88e82782fb--ficheFocus="
# As of Febuary 2026
...
name = "Landes"
root_link = 'https://archives.landes.fr/faire-une-recherche/archives-numerisees/etat-civil?arko_default_62a88e82782fb--ficheFocus='
...
def get_link(row) -> str:
    ...
    try:
        # three dots is already openned here
        # page.locator("button[data-cy='btn-toggle-volet']").click(timeout=1000)
        expect(page.locator('button[title="Partage et impression"]')).to_be_visible(timeout=2000)
        page.locator('button[title="Partage et impression"]').click(timeout=1000)
    except:
...
if __name__ == "__main__":
    with sync_playwright() as pw:
        browser = pw.chromium.launch(headless=False) # It failed when I ran it headlessly
