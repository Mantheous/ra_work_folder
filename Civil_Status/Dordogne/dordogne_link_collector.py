# Scraper for "https://archives.dordogne.fr/archives-numerisees/genealogie/registres-paroissiaux-et-detat-civil?arko_default_6197500eceff4--ficheFocus="
# As of Febuary 2026

# I found some records that don't have a cote. These records were single pages that contained no useful information.
# I think we will wait until all the data is scraped so the index of the csv is still related to the page number.
...
name = "Dordogne"
root_link = 'https://archives.dordogne.fr/archives-numerisees/genealogie/registres-paroissiaux-et-detat-civil?arko_default_6197500eceff4--ficheFocus='
...
def process_row(i: int):
    try:
        ...
        tries += 1
        if tries > max_tries:
            notify(message="Dordogne scraper failed to process row after max tries", subject="Dordogne Scraper Error")
            print("exiting...")
            exit()
